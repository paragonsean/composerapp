@if(isset($view) && in_array($view, ['subheadline', 'about-us', 'call-to-action', 'headline', 'mission-statement', 'newsletter', 'press-release', 'value-proposition', 'vision-statement']))
