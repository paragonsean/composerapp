                ...
                <div class="card-body p-4 d-flex flex-column">
                    ...
                    <div class="row m-n2">
                        ...
                        <div class="col-12 p-2 d-flex align-items-center">
                            ...
                            <div class="d-flex align-content-center {{ (__('lang_dir') == 'rtl' ? 'mr-2' : 'ml-2') }}" data-tooltip="true" title="{{ __('Access to :list templates.', ['list' => implode(', ', $templates->pluck('name')->toArray())]) }}">@include('icons.info', ['class' => 'text-muted width-4 height-4 fill-current'])</div>
                        </div>
